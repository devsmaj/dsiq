...
const sidebarItems = [
  ...
  { label: "Search Chats", href: "/dashboard", icon: Search },
...
export default function DashboardPage() {
  ...
  const { answers, user } = useUserProfile();
  ...
  const progressScore =
    progressMetrics.find((metric) => metric.label === "Progress score") ||
    progressMetrics[0];
    ...
    return (
      ...
      >
        ...
        <div className="relative border-t border-[color:var(--color-line)] pt-3">
          {isProfileMenuOpen ? (
            <div
              className={`absolute bottom-16 z-50 w-64 rounded-2xl border border-[color:var(--color-line)] bg-white p-2 shadow-[0_20px_60px_rgba(0,0,0,0.16)] ${
        ...
        <div className="flex min-h-screen">
          ...
          <section className="relative flex min-w-0 flex-1 flex-col bg-[color:var(--color-background)]">
            ...
            <div className="mx-auto flex min-h-screen w-full max-w-5xl flex-col px-5 pb-8 pt-24 sm:px-8 lg:justify-center lg:py-10">
              ...
              <div className="mx-auto mt-10 grid w-full max-w-5xl gap-4 md:grid-cols-2 xl:grid-cols-4">
                <article className="rounded-[1.35rem] border border-[color:var(--color-line)] bg-white p-5 shadow-[0_14px_40px_rgba(0,0,0,0.05)]">
                  <CheckCircle2
